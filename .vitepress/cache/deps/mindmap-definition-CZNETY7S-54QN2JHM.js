...
var getParent = __name(function(level) {
...
var getMindmap = __name(() => {
  return nodes.length > 0 ? nodes[0] : null;
}, "getMindmap");
var addNode = __name((level, id, descr, type) => {
  var _a, _b;
...
var MAX_SECTIONS = 12;
var defaultBkg = __name(function(db2, elem, node, section) {
  const rd = 5;
...
var rectBkg = __name(function(db2, elem, node) {
...
var cloudBkg = __name(function(db2, elem, node) {
  const w = node.width;
  const h = node.height;
  const r1 = 0.15 * w;
  const r2 = 0.25 * w;
...
var bangBkg = __name(function(db2, elem, node) {
  const w = node.width;
  const h = node.height;
  const r = 0.15 * w;
  elem.append("path").attr("id", "node-" + node.id).attr("class", "node-bkg node-" + db2.type2Str(node.type)).attr(
...
var circleBkg = __name(function(db2, elem, node) {
...
var roundedRectBkg = __name(function(db2, elem, node) {
...
var drawNode = __name(async function(db2, elem, node, fullSection, conf) {
...
var positionNode = __name(function(db2, node) {
...
var draw = __name(async (text, id, _version, diagObj) => {
  ...
  setupGraphViewbox(
    void 0,
    svg,
    ((_a = conf.mindmap) == null ? void 0 : _a.padding) ?? defaultConfig_default.mindmap.padding,
...
//# sourceMappingURL=mindmap-definition-CZNETY7S-54QN2JHM.js.map
