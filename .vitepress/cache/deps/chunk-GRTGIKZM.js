...
// node_modules/@mermaid-js/parser/dist/chunks/mermaid-parser.core/chunk-ORCS5NZH.mjs
...
function isTreemapDoc(item) {
  return reflection2.isInstance(item, TreemapDoc);
}
...
var MermaidAstReflection = (_a = class extends AbstractAstReflection {
  getAllTypes() {
    return [Architecture, Axis, Branch, Checkout, CherryPicking, ClassDefStatement, Commit, Curve, Direction, Edge, Entry, GitGraph, Group2, Info, Item, Junction, Leaf, Merge, Option2, Packet, PacketBlock, Pie, PieSection, Radar, Section, Service, Statement, TreemapDoc, TreemapRow];
  }
  computeIsSubtype(subtype, supertype) {
    switch (subtype) {
      case Branch:
...
//# sourceMappingURL=chunk-GRTGIKZM.js.map
