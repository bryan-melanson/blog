...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-3XYRH5AP.mjs
...
var sanitizeTextOrArray = __name((a2, config2) => {
  if (typeof a2 === "string") {
...
var placeholderToBreak = __name((s2) => {
  return s2.replace(/#br#/g, "<br/>");
}, "placeholderToBreak");
var breakToPlaceholder = __name((s2) => {
...
var renderKatex = __name(async (text2, config2) => {
  if (!hasKatex(text2)) {
    return text2;
  }
  ...
  if (true) {
    const { default: katex } = await import("./katex-H5TE2KZA.js");
...
var themes = {};
var getStyles = __name((type2, userStyles, options) => {
  let diagramStyles = "";
...
var addStylesForDiagram = __name((type2, diagramTheme) => {
...
var diagrams = {};
var registerDiagram = __name((id2, diagram, detector) => {
  var _a8;
  if (diagrams[id2]) {
...
function mercatorRaw(lambda, phi2) {
  return [lambda, log4(tan((halfPi4 + phi2) / 2))];
}
...
function transverseMercatorRaw(lambda, phi2) {
  return [log4(tan((halfPi4 + phi2) / 2)), -lambda];
}
...
*/
//# sourceMappingURL=chunk-FT5GUYLF.js.map
