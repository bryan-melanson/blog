import {
  populateCommonDb
} from "./chunk-FU5DRDYW.js";
import {
  parse
} from "./chunk-KILNKT4N.js";
import {
  ImperativeState
} from "./chunk-YXH4CG6P.js";
...
var addService = __name(function({
  id,
  icon,
  in: parent,
  title,
...
var getServices = __name(() => Object.values(state.records.nodes).filter(isArchitectureService), "getServices");
var addJunction = __name(function({ id, in: parent }) {
  state.records.registeredIds[id] = "node";
  state.records.nodes[id] = {
    id,
    type: "junction",
...
var getJunctions = __name(() => Object.values(state.records.nodes).filter(isArchitectureJunction), "getJunctions");
var getNodes = __name(() => Object.values(state.records.nodes), "getNodes");
var getNode = __name((id) => state.records.nodes[id], "getNode");
var addGroup = __name(function({ id, icon, in: parent, title }) {
  if (state.records.registeredIds[id] !== void 0) {
    throw new Error(
...
var getGroups = __name(() => {
  return Object.values(state.records.groups);
}, "getGroups");
var addEdge = __name(function({
  lhsId,
  rhsId,
  lhsDir,
  rhsDir,
...
var getEdges = __name(() => state.records.edges, "getEdges");
var getDataStructures = __name(() => {
...
var getElementById = __name((id) => state.records.elements[id], "getElementById");
...
var drawEdges = __name(async function(edgesEl, cy) {
...
var drawGroups = __name(async function(groupsEl, cy) {
  const padding = getConfigField("padding");
...
var drawServices = __name(async function(db2, elem, services) {
...
var drawJunctions = __name(function(db2, elem, junctions) {
...
//# sourceMappingURL=architectureDiagram-NQ2NVSRB-VZNZDZK3.js.map
