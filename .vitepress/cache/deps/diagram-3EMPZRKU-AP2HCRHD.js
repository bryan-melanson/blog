...
var getNodes = __name(() => state.records.nodes, "getNodes");
var addNode = __name((node, level) => {
...
var getRoot = __name(() => ({ name: "", children: state.records.outerNodes }), "getRoot");
var addClass = __name((id, _style) => {
...
var getClasses = __name(() => {
  return state.records.classes;
}, "getClasses");
var getStylesForClass = __name((classSelector) => {
  var _a;
  return ((_a = state.records.classes.get(classSelector)) == null ? void 0 : _a.styles) ?? [];
}, "getStylesForClass");
var clear2 = __name(() => {
  clear();
  state.reset();
...
var getClasses2 = __name(function(_text, diagramObj) {
...
//# sourceMappingURL=diagram-3EMPZRKU-AP2HCRHD.js.map
