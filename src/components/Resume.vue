...
export default {
  ...
  async created() {
    ...
    try {
      const response = await fetch("https://gist.githubusercontent.com/bryan-melanson/e4843ee863be3e76063a5b88e977daf1/raw/30f967781a92cda5f72a6502b64ee2e2f75b7881/resume.json");
      if (response.ok) {
